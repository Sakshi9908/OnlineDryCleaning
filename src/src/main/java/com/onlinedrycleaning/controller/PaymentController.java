...
public class PaymentController {
	...
	public ResponseEntity<Payment> getPaymentDetails(@PathVariable long paymentId)
			throws com.onlinedrycleaning.exception.IdNotFoundException {
	...
	@GetMapping("/pagingAndSortingPayment/{pageNumber}/{pageSize}/{sortProperty}")
	public Page<Payment> paymentPagination(@PathVariable Integer pageNumber, @PathVariable Integer pageSize,
			@PathVariable String sortProperty) {
		return paymentService.getPaymentPagination(pageNumber, pageSize, sortProperty);
	}
}
